...
<template>
    <a class="flex items-center" href="#">
        <img src="../../assets/img/logo-dewata.jpg" class="h-12 mr-2" alt="" />
        <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">Dewata Petshop</span>
    </a>
    <Button
        class="lg:!hidden"
        text
