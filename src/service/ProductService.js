        ...
        return [
            {
                ...
                umur: 1,
                anamnesa: 'Healthy',
                tanggalPeriksa: new Date('2025-01-02').toISOString().split('T')[0]
            },
            {
                id: '1001',
                namaPemilik: 'John',
                ...
                umur: 2,
                anamnesa: 'No Issues',
                tanggalPeriksa: new Date('2023-01-04').toISOString().split('T')[0]
            },
            {
                id: '1002',
                namaPemilik: 'Alice',
                ...
                umur: 1,
                anamnesa: 'Healthy',
                tanggalPeriksa: new Date('2023-01-05').toISOString().split('T')[0]
            },
            {
                id: '1003',
                namaPemilik: 'Sarah',
                ...
                jenisKelamin: 'Jantan',
                umur: 5,
                anamnesa: 'Has Allergy',
                tanggalPeriksa: new Date('2023-01-06').toISOString().split('T')[0]
            },
            {
                id: '1004',
                namaPemilik: 'Tom',
            ...
            },
            {
                ...
                umur: 3,
                anamnesa: 'Healthy',
                tanggalPeriksa: new Date('2023-03-06').toISOString().split('T')[0]
            },
            {
                id: '1008',
                namaPemilik: 'David',
